...
export default function ProjectProfilePage() {
  ...
  return <main>
    ...
    <section className="built-homes"><div><span className="kicker"><HomeIcon /> {texts.builtKicker}</span><h2>{texts.builtTitle}</h2><p>{texts.builtText}</p><a className="btn primary" href={scheduleHref}>AGENDAR VISITA <ArrowRight /></a></div><img src={builtImageUrl} alt="Casas modernas construidas en un residencial tropical" loading="lazy" decoding="async" /></section>
