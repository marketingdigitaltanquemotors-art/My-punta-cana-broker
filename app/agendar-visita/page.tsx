...
import { ArrowLeft, CalendarDays, Check, Clock3, LoaderCircle, MessageCircle, ShieldCheck } from 'lucide-react';
...
export default function ScheduleVisit() {
  ...
  const whatsapp = confirmation ? encodeURIComponent(`Hola, My Punta Cana Broker. Acabo de agendar una visita el día ${confirmation.date} a las ${showTime(confirmation.time)}. Mi código de reserva es ${confirmation.code}.`) : '';
