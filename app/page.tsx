...
export default function Home() {
  ...
  return <main>
    ...
    <section className="built-homes"><div><span className="kicker"><HomeIcon /> {texts.builtKicker}</span><h2>{texts.builtTitle}</h2><p>{texts.builtText}</p><a className="btn primary" href="/agendar-visita">AGENDAR VISITA <ArrowRight /></a></div><BuiltHomesCarousel images={builtImageUrls} /></section>
