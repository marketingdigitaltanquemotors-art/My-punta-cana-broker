...
export default function Home() {
  ...
  return <main>
    ...
    <section id="inicio" className="hero hero-simple"><div className="hero-media" aria-hidden="true">{heroVideoUrl ? <video src={heroVideoUrl} poster="/hero-solar-v1.png" autoPlay muted loop playsInline onError={() => setHeroVideoUrl('')} /> : <img src="/hero-solar-v1.png" alt="" />}</div><div className="hero-shade" aria-hidden="true"/><div className="hero-copy"><span className="eyebrow"><MapPin /> PUNTA CANA · BÁVARO</span>{projectName && <span className="project-badge">{projectName}</span>}<h1>Encuentra tu solar en el centro de <em>Punta Cana-Bávaro, cerca de todo.</em></h1><p>Agenda una visita personalizada en Punta Cana-Bávaro de manera rápida y sencilla.</p><div className="hero-offers"><span><b>Desde un 15%</b></span><span><b>Desde 150$</b> por mentro</span></div><div className="hero-actions"><a className="btn primary" href="/agendar-visita">AGENDAR VISITA <CalendarDays /></a></div><div className="trust"><span><ShieldCheck /> Proceso transparente</span><span><Trees /> Ubicaciones con potencial</span><span><CalendarDays /> Visitas personalizadas</span></div></div></section>
    <section className="built-homes"><div><span className="kicker"><HomeIcon /> CASAS CONSTRUIDAS</span><h2>Imagina tu casa hecha realidad en Punta Cana-Bávaro.</h2><p>Estos solares son una oportunidad para construir cerca de todo, con una visión clara de comunidad, acceso y futuro crecimiento.</p><a className="btn primary" href="/agendar-visita">AGENDAR VISITA <ArrowRight /></a></div><img src="/casas-construidas-v1.png" alt="Casas modernas construidas en un residencial tropical" /></section>
